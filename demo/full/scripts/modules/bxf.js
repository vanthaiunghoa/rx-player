...
const channelLogoURL = "http://127.0.0.1:8089/tmp/series.png";
                  ...
                  getManifestURL(token, video.affaire, video.pgrm).then(({ manifestURL, licenseURL }) => {
                    ...
                    xhr.onload = (evt) => {
                      ...
                      contents.push({
                        ...
                        startTime: video.startTime,
                        endTime: Math.min(video.endTime, video.startTime + scaledDuration),
                        transport: "smooth",
                        textTracks
                      });
                      ...
                      if (logos) {
                        logos.forEach((logo) => {
                          ...
                          if (url) {
                            ...
                            const overlayData = JSON.parse(JSON.stringify(overlay));
