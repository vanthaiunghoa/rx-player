...
const pictos = {
  ...
  "Interdit en salle -10": "http://127.0.0.1:8089/tmp/picto10.png",
  "Interdit en salle -12": "http://127.0.0.1:8089/tmp/picto12.png",
  "Interdit en salle -16": "http://127.0.0.1:8089/tmp/picto16.png",
  "Interdit en salle -18": "http://127.0.0.1:8089/tmp/picto18.png",
}
      ...
      if (contents.length >= 1) {
        ...
        getServerCertifcate().then((certificate) => {
          ...
          player.loadVideo({
            ...
            startAt: startAt != null ? { wallClockTime: startAt } : null,
          });
        });
      }
    });
