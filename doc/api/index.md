...
### <a name="basicmediaplayback"></a>Media playback
...
You might want to start playback automatically when enough media has been loaded. Then you can configure auto playback with:
- autoPlay ( `boolean` )
  - Default is `false`.
...
### <a name="encryptedmediaplayback"></a>Encrypted media playback
...
### Advanced encrypted media playback